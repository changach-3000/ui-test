...
const ProfileSidebar = () => {
  ...
  if (!profileDetails) {
    return <div>No profile has been selected</div>;
  }
  ...
  return (
    <>
        ...
        <aside className="bg-white w-96 h-full p-4">
          ...
          <nav>
            <div className="flex justify-center gap-4">
              ...
              <span className="justify-end p-1" onClick={toggleSidebar}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
                  height="20"
      ...
      {!sidebarVisible && (
        <div className="rounded-full bg-white shadow p-1 cursor-pointer" onClick={toggleSidebar}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="20"
          height="20"
